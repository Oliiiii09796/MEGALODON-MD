...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~cdJwmYCR#S3II36PO4XGuouKA32raeHG__58Te0vfq1khY_3NlDc",  // Your bot's session ID (keep it secure)
    
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "MEGALODON-MD",  // Bot's display name
    
    MODE: process.env.MODE || "privé",        // Bot mode: public/private/group/inbox

    // ===== OWNER & DEVELOPER SETTINGS =====
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50940965568",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "乂FᎶ•Vɪʀᴜѕ乂",           // Owner's name
    
    DEV: process.env.DEV || "50940965568",                     // Developer's contact number
